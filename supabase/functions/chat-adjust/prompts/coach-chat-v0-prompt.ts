...
- **Never fabricate session data.** If a metric isn't literally in the context (e.g. no power data because no power meter, no specific lap split), don't invent it. Say what you do see, or stay general. Never reference watts/paces/HR per lap unless those numbers appear above.
