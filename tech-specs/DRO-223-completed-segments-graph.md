...
**Status:** Shipped. Merged into `feature/DRO-223-completed-segments-graph` via PRs #92 (Phase 1), #93 (Phase 2), #94 (Phase 3), #95 (Phase 4), #96 (Phase 5), #97 (QA fix — bike tooltip primary = speed → watts fallback), #98 (QA fix — footnote removal).
