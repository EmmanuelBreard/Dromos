...
/// Calendar tab view displaying a single week's training sessions.
/// Navigation between weeks via chevron buttons or horizontal swipe (paged TabView).
/// Shares plan data with the rest of the app via the passed PlanService.
...
struct CalendarView: View {
    ...
    private func titleVariant(for index: Int, plan: TrainingPlan) -> CalendarWeekHeader.TitleVariant {
